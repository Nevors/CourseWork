...
namespace CourseWork.Grammar.Html.EditToken {
    class ChangeTokenScript : IChangeToken {
        ITokenFactory factoryTokens;
        ITextEditor textEditor;

        public ChangeTokenScript(ITokenFactory factoryTokens, IFactoryEditor factoryEditor) {
            this.factoryTokens = factoryTokens;
            this.textEditor = factoryEditor.GetEditor((int)TypeEditor.Js);
        }
